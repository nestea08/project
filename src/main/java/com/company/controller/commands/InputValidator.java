...
public class InputValidator {
    static final String EMAIL_REGEX = "^[a-zA-Z0-9_.-]{4,15}@[a-z0-9_-]+(\\.[a-z0-9_-]+)*\\.[a-z]{2,6}$";
    static final String PASSWORD_REGEX = "^[a-zA-Z0-9_.-]{4,20}$";
    static final String NICKNAME_REGEX = "^[a-zA-Z0-9_.-]{4,12}$";
