...
<div class="content">
    <div class="login_div_holder">
        <div class="login_div">
            ...
            <form class="login_form" method="post" action="${pageContext.request.contextPath}/guest/login">
                ...
                <input class="login_submit" type="submit" value="<fmt:message key="login.submit"/>">
            </form>
